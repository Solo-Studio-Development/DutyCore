...
public class Webhook {
    ...
    public static int countEnabledWebhooks() {
        ConfigurationSection section = DutyCore.getInstance().getWebhookFile().getSection("webhook");
    ...
    public static void sendWebhookFromString(@NotNull String path, @Nullable PlaceholderProvider event) throws IOException, URISyntaxException {
        ConfigurationSection section = DutyCore.getInstance().getWebhookFile().getSection(path);

        if (section == null) return;

        String globalUrl = DutyCore.getInstance().getWebhookFile().getString("global-url");
